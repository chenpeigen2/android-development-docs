...
1. [概述](#1-概述)
   - 1.1 [Handler 的作用](#11-handler-的作用)
   - 1.2 [核心组件](#12-核心组件)
2. [整体架构](#2-整体架构)
   - 2.1 [组件关系图](#21-组件关系图)
   - 2.2 [组件持有关系](#22-组件持有关系)
   - 2.3 [完整工作流程](#23-完整工作流程)
3. [ThreadLocal 详解](#3-threadlocal-详解)
   - 3.1 [ThreadLocal 原理](#31-threadlocal-原理)
   - 3.2 [ThreadLocal 源码分析](#32-threadlocal-源码分析)
   - 3.3 [Looper 中的 ThreadLocal 使用](#33-looper-中的-threadlocal-使用)
4. [Looper 详解](#4-looper-详解)
   - 4.1 [Looper 核心职责](#41-looper-核心职责)
   - 4.2 [Looper 源码分析](#42-looper-源码分析)
   - 4.3 [主线程 Looper 初始化](#43-主线程-looper-初始化)
5. [MessageQueue 详解](#5-messagequeue-详解)
   - 5.1 [MessageQueue 数据结构](#51-messagequeue-数据结构)
   - 5.2 [MessageQueue 源码分析](#52-messagequeue-源码分析)
6. [Message 详解](#6-message-详解)
   - 6.1 [Message 结构](#61-message-结构)
   - 6.2 [消息池复用机制](#62-消息池复用机制)
7. [Handler 详解](#7-handler-详解)
   - 7.1 [Handler 构造函数](#71-handler-构造函数)
   - 7.2 [发送消息](#72-发送消息)
   - 7.3 [处理消息](#73-处理消息)
8. [Native 层实现](#8-native-层实现)
   - 8.1 [Native 方法](#81-native-方法)
   - 8.2 [epoll 机制](#82-epoll-机制)
9. [同步屏障机制](#9-同步屏障机制)
   - 9.1 [同步屏障原理](#91-同步屏障原理)
